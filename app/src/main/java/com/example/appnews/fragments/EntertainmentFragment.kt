...
class EntertainmentFragment:Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.entertainment_fragment,null)
        ...
        recyclerViewEntertainment.adapter=newsAdapter
        findNews()
        return view
    }
    fun findNews(){
        ApiUtilities.getApiInterface().getCategoryNews("us","entertainment",100,api).enqueue(object: Callback<MainNews> {
